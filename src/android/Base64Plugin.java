...
package com.hanwintech.custom.cordova.base64;
	...
	private String encodeFile(String filePath) {
		...
		try {
			...
			if (_uri != null && "content".equals(_uri.getScheme())) {
				Cursor cursor = cordova.getActivity().getContentResolver().query(_uri,
			...
			String mimeString = mimeTypeMap.getMimeTypeFromExtension(MimeTypeMap.getFileExtensionFromUrl(filePath));
			imgStr = "data:" + mimeString + ";base64," + new String(base64, "US-ASCII");
		} catch (Exception e) {
			return imgStr;
		}
		return imgStr;
